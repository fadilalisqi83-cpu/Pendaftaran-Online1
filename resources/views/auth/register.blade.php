...
<head>
    ...
    <title>Daftar - TK Islam Ar-Rasyid</title>
    <!-- Import Google Font -->
    ...
    <style>
        * {
        ...
        body {
            ...
            display: flex;
            flex-direction: column; /* Mengubah arah flex jadi vertikal */
            justify-content: center;
            align-items: center;
            padding: 20px;
        }

        /* --- Bagian Header (Sekarang di luar Card) --- */
        .page-header {
            text-align: center;
            margin-bottom: 32px;
            display: flex;
...
@endif
    ...
    <div class="input-wrapper">
        ...
        <input type="text" name="name" class="form-input" placeholder="Masukkan nama lengkap" required>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <!-- Ikon User (Sesuai gambar pakai ikon user lagi) -->
                    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                        <circle cx="12" cy="7" r="4"/>
                    </svg>
            ...
            <div class="form-group">
                <div class="form-label-container">
                    ...
                    <!-- Sesuai gambar, ada Lupa Sandi? di halaman daftar -->
                    <a href="{{ url('/forgot-password') }}" class="link-lupa-sandi">Lupa Sandi?</a>
                </div>
    ...
    <div class="input-wrapper">
        <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        ...
        <div class="card-footer">
            <!-- Sesuai teks di gambar: "Sudah punya akun? Daftar" -> Gw arahin ke URL login ya logikanya -->
